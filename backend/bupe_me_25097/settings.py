"""
Django settings for bupe_me_25097 project.
...
SECRET_KEY = env.str("SECRET_KEY", "@tx5jk1q+tdvs7q43l#2kgge!!btagl)e$t$ox0l&o1hyqqql3")
...
ROOT_URLCONF = 'bupe_me_25097.urls'
...
WSGI_APPLICATION = 'bupe_me_25097.wsgi.application'
