      ...
      <q-card  class="q-pa-md q-ma-none no-shadow bg-white main-card-bg" style="width:420px;">
        ...
        <q-card-section class="text-grey-8" v-if="screen == 1">
          <q-form class="q-gutter-md">
            ...
            <q-select square filled v-model="zip" input-debounce="0" use-input @filter="filterFn" :options="zipOptions" class="main-select-bg">
              <template v-slot:selected>
                <template v-if="zip">
                  <span style="font-family: Roboto; font-size:16px; font-style:normal;color:rgba(0, 0, 0, 0.87); padding-left: 10px">{{ zip }}</span>
                </template>
                <template v-else>
                  <span style="font-family: Roboto; font-size:16px; font-style:normal;color:rgba(0, 0, 0, 0.6); padding-left: 10px">Zip*</span>
                </template>
              </template>
            </q-select>
  ...
  methods: {
    filterFn (val, update) {
      ...
      update(() => {
        ...
        this.zipOptions = zipCodes.filter(v => v.toLowerCase().indexOf(needle) > -1)
      })
    },
    registration () {
      if (this.email === '' || this.firstName === '' || this.lastName === '' || this.dob === '' || this.phone === '' || this.city === '' || this.zip === '' || this.password === '' || this.street1 === '') {
        this.$q.notify({
          type: 'negative',
